...
const Security = ({ navigation, props }) => {
    ...
    const [confirmCode, setConfirmCode] = useState(true); //show oTpCode View
        ...
        return (
            <Modal
                ...
                <RLSucessModal
                    ...
                    onpressbutton={() => navigation.navigate('ShopList')} />
            </Modal>
        )
    }
        ...
        return (
            <View style={topUpStyles.verifyCodeResendBtnView}>
                <RLButton
                    ...
                    simplebuttontext={BaseText.VerifyOTP}
                    simplebuttontextStyle={buttonStyle.buttonTextStyle}
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>                        
                        {confirmCode &&
                            <View style={topUpStyles.addDebitMainView}>
                                <RLText text={BaseText.ConfirmOTPDescription} style={topUpStyles.confirmTitleText} />
